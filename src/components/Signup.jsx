...
function Signup() {
    ...
    return (
        <div className='w-screen h-[87.7vh] flex items-center justify-center'>
            <form onSubmit={handleSubmit(onSubmit)} className="w-[90%] md:w-[75vw] bg-[#111] p-8 neon-border rounded-lg grid grid-cols-1 md:grid-cols-2 gap-6">
                <h2 className="col-span-full text-center text-2xl font-bold text-white mb-6">New User Registration</h2>
